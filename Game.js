...
function decisionScenario(question, options, correctAnswerIndex) {
    ...
    for (let i = 0; i < options.length; i++) { // fix loop to iterate properly
        const j = i;
    ...
    if (playerAnswer === correctAnswerIndex) {//display correct phrase when correct answer is chosen
        console.log('Correct! You made an environment-friendly decision. +1 point.');
        score++;//fix point addition
    } else {
